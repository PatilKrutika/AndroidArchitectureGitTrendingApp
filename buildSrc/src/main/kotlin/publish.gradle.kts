        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/patilkrutika/androidarchitecturegittrendingapp/")
                    ...
                    developers {
                        developer {
                            id.set("patilkrutika")
                            name.set("patilkrutika")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/patilkrutika/androidarchitecturegittrendingapp.git")
                        developerConnection.set("scm:git:ssh://github.com/patilkrutika/androidarchitecturegittrendingapp.git")
                        url.set("https://github.com/patilkrutika/androidarchitecturegittrendingapp/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/patilkrutika/androidarchitecturegittrendingapp/issues")
                    }
                }
            }
        }
